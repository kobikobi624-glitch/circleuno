...
const ITEMS = [
  ...
  { q: "מה זה כלי התרגול?", a: "תרגיל מובנה של כ-5 דקות שמוביל אותך דרך נשימה, זיהוי תחושה, ישיבה עם אי-נוחות ורפלקציה. לחץ על הבאנר העליון 'תרגיל התמודדות' כדי להתחיל." },
